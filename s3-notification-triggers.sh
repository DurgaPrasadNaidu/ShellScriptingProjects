...
bucket_name="Durgaprasad-ultimate-bucket"
lambda_func_name="s3-lambda-function"
role_name="s3-lambda-sns"
email_address="durgaprasadj374@gmail.com"
...
aws sns publish \
  ...
  --message "Hello from Durgaprasad YouTube channel, Learn DevOps Zero to Hero for Free"
